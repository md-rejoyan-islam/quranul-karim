  ...
  return (
    <>
      <nav className=" border-border_color dark:border-dark_border_color sticky top-0 w-full top- z-50 border-b backdrop-blur-md ">
        <div className=" flex justify-between items-center   h-[66px] lg:h-[66px]  max-w-[1276px] mx-auto">
          <span
            onClick={close}
          ...
          <div className="middle flex flex-col  justify-end items-center relative">
            ...
            <div className=" text-[11px] sm:text-[13px] flex flex-row justify-center  items-baseline ">
